...
ActiveRecord::Schema.define(:version => 20110802004724) do
  ...
  add_index "comentarios", ["comment_id"], :name => "index_comentarios_on_comment_id"
  ...
  add_index "versiculos", ["texto"], :name => "texto"
